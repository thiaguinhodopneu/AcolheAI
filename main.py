...
def index():
    ...
    Basta acessar http://localhost:5500 no navegador
    """
...
def status():
    ...
    return jsonify({"status": "online", "bot": "AcolheAI"})


if __name__ == "__main__":
    print("=" * 55)
    print("   AcolheAI rodando!")
    print("   Acesse: http://localhost:5500")
    print("   API em: http://localhost:5500/chat")
    print("   Status: http://localhost:5500/status")
    print("=" * 55)
